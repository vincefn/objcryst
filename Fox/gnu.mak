...
Fox:
	$(MAKE) -f gnu.mak wxcryst=1 opengl=1 fftw=1 debug=$(debug) shared=$(shared) shared-wxgtk=$(shared-wxgtk) shared-freeglut=$(shared-freeglut) shared-newmat=$(shared-newmat) shared-fftw=$(shared-fftw) -C src Fox
