...
# Now copy the boost parts cctbx needs - This is up-to-date for boost 1.86
rsync -ar /usr/local/cctbx/cctbx_sources/boost/boost --exclude="accumulators/" --exclude="archive/" --exclude="asio/" --exclude="asign/" --exclude="bimap/" --exclude="circular_buffer/" --exclude="concept_check/" --exclude="dynamic_bitset/" --exclude="filesystem/" --exclude="flyweight/" --exclude="function_types/"  --exclude="gil/" --exclude="graph/" --exclude="interprocess/" --exclude="intrusive/" --exclude="iostreams/" --exclude="lambda/" --exclude="logic/" --exclude="mpi/" --exclude="parameter/" --exclude="pending/" --exclude="pool/" --exclude="program_options/" --exclude="proto/" --exclude="ptr_container/" --exclude="python/" --exclude="random/" --exclude="regex/" --exclude="serialization/" --exclude="signals/" --exclude="spirit/" --exclude="statechart/" --exclude="system/" --exclude="test/" --exclude="thread/" --exclude="units/" --exclude="unordered/" --exclude="variant/" --exclude="wave/" --exclude="xpressive/" --exclude="charconv" --exclude="scope" --exclude="cobalt" --exclude="redis" --exclude="compat" --exclude="mysql" --exclude="url" --exclude="describe" --exclude="lambda2" --exclude="json" --exclude="leaf" --exclude="pfr" --exclude="stl_interfaces" --exclude="nowide" --exclude="static_string" --exclude="variant2" --exclude="outcome" --exclude="histogram" --exclude="safe_numerics" --filter="+ */" --filter="+ *.hpp"  --filter="+ *.ipp" --filter="- *" include/
