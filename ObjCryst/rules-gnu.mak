...
ifeq ($(wxcryst),1)
   ...
   WX_LDFLAGS =  -L$(DIR_WXWINDOWS)/lib -L/usr/lib -L/usr/X11R6/lib -lwxcryst -lwx_gtk -lgtk -lgdk -rdynamic -lgmodule -lgthread -lglib -lpthread -ldl -lXi -lXext -lX11 -lXmu ${GL_WX_LIB} 
else
   WXCRYSTFLAGS :=
   WX_LDFLAGS :=
endif
