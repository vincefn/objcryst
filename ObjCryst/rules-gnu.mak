...
#MySQL C++ connector
#$(BUILD_DIR)/mysql-connector-c++-1.1.5.tar.gz:
#	cd $(BUILD_DIR) && $(DOWNLOAD_COMMAND) http://dev.mysql.com/get/Downloads/Connector-C++/mysql-connector-c++-1.1.5.tar.gz

#libmysql-connector: $(BUILD_DIR)/mysql-connector-c++-1.1.5.tar.gz libboost
#	cd $(BUILD_DIR) && tar -xzf mysql-connector-c++-1.1.5.tar.gz
#	cmake -DCMAKE_INSTALL_PREFIX=$(DIR_STATIC_LIBS) -DMYSQL_CONFIG_EXECUTABLE:FILEPATH=$(DIR_STATIC_LIBS)/bin/mysql_config -DBOOST_ROOT=$(BUILD_DIR)/cctbx/include/
#	$(MAKE) -j4 install
