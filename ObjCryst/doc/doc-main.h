...
* (see \ref page_legal).
*
*\section testing Non-GUI test suite
*
* The repository includes a non-GUI test suite in the top-level \c test/ directory.
* It focuses on library-level and CLI workflows while avoiding the wxWidgets GUI path.
*
*\par Run from ObjCryst
* \code
* cd ObjCryst
...
* * non-GUI integration tests for \c Fox-nogui including tutorial datasets
