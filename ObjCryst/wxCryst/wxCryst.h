...
enum
{
   ...
   ID_WXFIELD_REFPAR_LIMITEDBUTTON,
   ...
   ID_CRYSTAL_MENU_SCATT_ADDSCATTPOWSPHERE,
   ID_CRYSTAL_MENU_SCATT_ADDATOM,
   ID_CRYSTAL_MENU_SCATT_ADDZSCATTERER,
   ID_CRYSTAL_MENU_SCATT_ADDMOLECULE,
   ...
   ID_GLCRYSTAL_MENU_SHOWCRYSTAL,
   ID_GLCRYSTAL_MENU_LOADFOURIER, 
   ID_GLCRYSTAL_MENU_CHANGECONTOUR,   
   ID_GLCRYSTAL_MENU_ADDCONTOUR,   
   ID_GLCRYSTAL_MENU_SHOWFOURIER,
   ID_GLCRYSTAL_MENU_FOURIERCHANGECOLOR,
   ID_GLCRYSTAL_MENU_SHOWWIRE,
   ID_GLCRYSTAL_MENU_UNLOADFOURIER,
   ID_GLCRYSTAL_MENU_FOURIERCHANGEBBOX,   
   ID_ZATOM_NAME,
   ID_ZATOM_SCATTPOW,
   ID_ZATOM_BOND,
   ID_ZATOM_ANGLE,
   ...
   ID_POWDERSPECTRUM_MENU_IMPORT_FULLPROF4,
   ID_POWDERSPECTRUM_MENU_IMPORT_MULTIDETECTORLLBG42,
   ...
   ID_DIFFSINGLECRYST_MENU_SAVEHKLFCALC,   
